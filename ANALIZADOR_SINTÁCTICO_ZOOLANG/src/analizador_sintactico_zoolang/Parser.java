...
public class Parser {
    ...
    public Parser() {
        ...
        producciones = new String[][]{
            ...
            {"<DelVariable>", "420", "<TipoPrimitivo>", "<DeclInicializada>"},
            {"<DelVariable>", "500", "<DeclObj>"},
            {"<DelVariable>", "<AsignacionObj>"},
            {"<DelVariable>", "<AsignacionArreglo>"},
            {"<DelVariable>", "<AsignacionElemArr>"},
            {"<DeclSimple>", "<ListaIds>", "456"},
            {"<DeclSimple>", "<DeclInicializada>"},
            {"<DeclSimple>", "<Arreglos>", "456"},
            {"<DeclInicializada>", "<Inicializar>"},
            {"<DeclInicializada>", "<InicializarArreglos>"},
            {"<DeclObj>", "<ObjSimple>"},
            {"<DeclObj>", "<ObjArreglo>"},
            ...
            {"<IniObjArregloOpcional>", "506", "418", "500", "454", "<DimenPosicion>", "455"},
            {"<IniObjArregloOpcional>"},
            {"<AsignacionObj>", "500", "506", "418", "500", "450", "<Argumentos>", "451", "456"},
            {"<AsignacionArreglo>", "500", "506", "418", "500", "454", "<DimenPosicion>", "455", "456"},
            {"<AsignacionElemArr>", "500", "454", "<DimenPosicion>", "455", "506", "418", "500", "450", "<Argumentos>", "451", "456"},
            {"<ObjDirectoParametro>", "418", "500", "450", "<Argumentos>", "451"},
            {"<ListaIds>", "500", "<ListaIdsCont>"},
            {"<ListaIdsCont>", "458", "<ListaIds>"},
            {"<ListaIdsCont>"},
            {"<Inicializar>", "500", "506", "<Valor>", "<MasDeclInicializadas>", "456"},
            {"<MasDeclInicializadas>", "458", "<Inicializar>"},
            {"<MasDeclInicializadas>"},
            {"<Arreglos>", "500", "454", "<DimenPosicion>", "455", "<MasArreglos>"},
            {"<MasArreglos>", "458", "<Arreglos>"},
            {"<MasArreglos>"},
            {"<InicializarArreglos>", "500", "454", "455", "507", "452", "<ListaValores>", "453", "<MasIniArreglos>", "456"},
            ...
            {"<Valor>", "501"},
            {"<Valor>", "502"},
            {"<Valor>", "500", "454", "<DimenPosicion>", "455"},
            {"<Num>", "503"},
            {"<Num>", "504"},
            {"<Booleanos>", "433"},
            {"<Booleanos>", "434"},
            ...
            {"<TipoPrimitivo>", "415"},
            {"<TipoPrimitivo>", "416"},
            {"<Clase>", "403", "500", "452", "<Miembros>", "453", "456"},
            ...
            {"<MetodoConRetorno>", "<TipoPrimitivo>", "<MetPrefijo>", "500", "450", "<Parametros>", "451", "452", "<Instrucciones>", "421", "<Valor>", "456", "453"},
            ...
            {"<Func>", "<FuncConRetorno>"},
            {"<Func>", "<FuncCorpse>"},
            {"<FuncConRetorno>", "<TipoPrimitivo>", "500", "450", "<Parametros>", "451", "452", "<Instrucciones>", "421", "<Valor>", "456", "453"},
            ...
            {"<Switch>", "429", "450", "<Expre>", "451", "452", "<ListaReacciones>", "453"},
